...
-  **Vim 和 Vi 的关系**
    ...
    | 功能           | Vi                 | Vim                                  |
    | -------------- | ------------------ | ------------------------------------ |
    | 基本编辑功能   | 支持基础的文本编辑 | 完全兼容 Vi 的所有功能               | 多级撤销 | 仅支持一次撤销 | 支持多级撤销 （u 撤销，Ctrl-R 重做) |
    | 语法高亮       | 不支持             | 支持语法高亮，便于代码阅读           | 插件支持 | 不支持         | 丰富的插件生态，支持扩展功能       | 搜索与替换 | 支持简单的搜索替换功能 | 增强搜索功能（高亮匹配、正则表达式支持更好) |
    | 窗口分屏       | 不支持             | 支持多窗口分屏和标签页               | 图形界面 | 不支持         | 提供图形化版本（GVim)             |
